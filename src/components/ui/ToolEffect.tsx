    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
            ...
            <div className={`relative transition-all duration-500 ${getAnimationClass()}`}>
                ...
                {/* Title text */}
                <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 text-center w-full max-w-xs">
                    <div 
                        className="text-lg font-bold text-white animate-pulse-custom whitespace-nowrap"
                        style={{
                            textShadow: '0 0px 5px rgba(0, 0, 0, 0.25), 0 0px 25px rgba(0, 0, 0, 0.25)',
                        }}
                    >
                        {toolInfo.title}
                    </div>
